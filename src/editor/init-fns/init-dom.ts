...
import { EMPTY_P, Change_Empty_P } from '../../utils/const'
...
export default function (editor: Editor): void {
   ...
   * zzb
   */
  Change_Empty_P(config.hasPOrBr)
  ...
  if ($children && $children.length) {
    ...
    // console.log('EMPTY_P: ', EMPTY_P);
    config.hasPOrBr && $textElem.append($(EMPTY_P)) // 新增一行，方便继续编辑
